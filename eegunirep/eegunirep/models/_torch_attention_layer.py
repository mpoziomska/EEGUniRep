...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
                 kdim=None, vdim=None, batch_first=False, device=None, dtype=None, add_rot_pos_emb=False) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        super().__init__()
        self.add_rot_pos_emb = add_rot_pos_emb
        ...
        self.add_rot_pos_emb = add_rot_pos_emb
        if add_rot_pos_emb:
            self.rot_pos_emb = RotaryEmbedding(dim = self.head_dim)
    ...
    Outputs:
        ...
        if self.add_rot_pos_emb:
            query = self.rot_pos_emb.rotate_queries_or_keys(query)
            key = self.rot_pos_emb.rotate_queries_or_keys(key)
...
class TransformerEncoderLayer(torch.nn.TransformerEncoderLayer):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
                 ...
                 device=None, dtype=None, add_rot_pos_emb=False) -> None:
        factory_kwargs = {'device': device, 'dtype': dtype}
        ...
        self.self_attn = MultiheadAttention(d_model, nhead, dropout=dropout, batch_first=batch_first, add_rot_pos_emb=add_rot_pos_emb,
                                            **factory_kwargs)
